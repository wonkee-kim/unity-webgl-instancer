...
public class VertexAnimationRenderer : MonoBehaviour
{
    ...
    private int[] normalTexturePropertyIDs;
    private int texelSizePropertyID;
    private int animationParamsPropertyID;
    ...
    private void OnValidate()
    {
        ...
        {
            Debug.LogWarning($"SkinnedMeshRenderer.sharedMesh does not match VertexAnimationDataObject.mesh on {gameObject.name}.");
        }
    ...
    private void Setup()
    {
        ...
        positionTexturePropertyIDs = new int[4]
        {
        ...
        normalTexturePropertyIDs = new int[4]
        {
        ...
        texelSizePropertyID = _materialPropertyIDs[animationDataObject.texelSizePropertyName];
        animationParamsPropertyID = _materialPropertyIDs[animationDataObject.animationParamsPropertyName];
        texelSize = animationDataObject.texelSize; // vertex count
        ...
        _meshRenderer.material.SetFloat(texelSizePropertyID, texelSize);
        _meshRenderer.material.SetVector(animationParamsPropertyID, animationParams);
    }
}
